...
const Advertisement = ({ adType, adId })=>{
    const [ad, setAd] = react_1.default.useState(null);
    react_1.default.useEffect(()=>{
        const fetchAd = ()=>__awaiter(void 0, void 0, void 0, function*() {
                try {
                    const response = yield fetch(`http://192.168.0.17:8000/ads/${adId}`);
    ...
    return react_1.default.createElement("div", {
        style: Object.assign(Object.assign({}, sizeStyles[adType]), {
            overflow: 'hidden',
            position: 'relative'
        })
    }, ad ? react_1.default.createElement("img", {
        src: ad,
        alt: "Advertisement",
        style: {
            width: '100%',
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__decea1._.js.map